...
class PurchaseInvoiceItem(BaseModel):
    ...
    amount: float | None = Field(None, description="qty * rate (gross amount before discount)")
    discount_percentage: float | None = Field(None, description="Discount percentage on this item")
    discount_amount: float | None = Field(None, description="Discount amount on this item")
    net_amount: float | None = Field(None, description="Amount after discount (amount - discount_amount)")
    tax_rate: float | None = Field(None, description="Tax rate percentage applicable to this item")
    tax_amount: float | None = Field(None, description="Tax amount on this item")
...
class PurchaseTax(BaseModel):
    charge_type: str = Field(
        default="On Net Total", description="Actual | On Net Total | On Previous Row Amount | On Previous Row Total"
    )
    ...
    rate: float | None = Field(None, description="Tax rate percentage")
    tax_amount: float | None = Field(None, description="Fixed tax amount (for Actual type)")
...
class PurchaseInvoice(BaseModel):
    ...
    shipping_address: Address = Field(
        default_factory=Address, description="Ship To address (if different from billing)"
    )
    ...
    due_date: str | None = Field(None, description="Payment due date YYYY-MM-DD")
    bill_no: str | None = Field(None, description="Supplier's invoice number")
    bill_date: str | None = Field(None, description="Supplier's invoice date")
    ...
    taxes: list[PurchaseTax] | None = Field(default=None, description="Taxes and charges")
    total: float | None = Field(None, description="Net total before tax")
    discount_amount: float | None = Field(None, description="Total discount amount on invoice")
    grand_total: float | None = Field(None, description="Total including tax")
